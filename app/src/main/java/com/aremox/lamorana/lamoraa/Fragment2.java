...
public class Fragment2 extends Fragment  implements
    ...
    // recicle view
    private LinearLayout recViewLogin;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(recViewLogin.getContext())
    ...
    private boolean checkAccountsPermission() {
        ...
        if (permissionCheck == PackageManager.PERMISSION_GRANTED) {
            ...
            Snackbar.make(recViewLogin.findViewById(R.id.login_layout),
    ...
    private void onSignInClicked() {
        ...
        Log.d(TAG, "onSignInClicked:" + R.string.signing_in);
    }
